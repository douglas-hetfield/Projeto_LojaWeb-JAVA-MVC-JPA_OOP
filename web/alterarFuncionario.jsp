        ...
        <form class="form" action="fc" method="post">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="nome" value="${funcionario.nome}" class="form-control" required placeholder="Informe seu nome">
                </div>
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <input type="email" name="email" value="${funcionario.email}" class="form-control" required placeholder="digite seu E-mail">
                </div>

                <div class="form-group">
                    <label for="cargo">Cargo:</label>
                    <select class=" form-control" value="${funcionario.cargo}" name="cargo" id="cargo" >
